...
const MenuButton = ({ 
    ...
    setShowSimulation, 
    setShowPredictions, 
    setShowGlobalPredictions, 
    setShowDictionary, 
    setShowEducational, 
    setIsRatingModalOpen,
    setShowRatingsDashboard  // Añadido nuevo prop
}) => {
        ...
        <div className="fixed z-50 left-4 bottom-4">
            ...
            {isOpen && (
                ...
                `}>
                    ...
                    <button
                        onClick={() => handleOptionClick(setShowRatingsDashboard)}
                        className="w-full px-4 py-3 flex items-center gap-3 text-white hover:bg-white/10 transition-colors"
                    >
                        <Star size={20} className="text-yellow-400" />
                        <span>Dashboard de Valoraciones</span>
                    </button>
